create table UserName(  LastName varchar(255),FirstName varchar(255),username VARCHAR(50) NOT NULL UNIQUE,FirstName VARCHAR(50));

use authenticationapi_db;
ALTER TABLE UserName ADD FirstName VARCHAR(255), LastName VARCHAR(255);
Drop  table UserName;
